...
% General statements
%
% - Evolution is not a biological concept/phenomenon;
%   "Darwin’s principles of evolutionary change are universal" (Adami, 2006)
%   - Like the gradient of ions during TCA is not strictly biological,
%     yet it exists in biology
% - "It does not make sense to tie evolution to a carbon substrate"
%   (Pennock 2007)
% - "They apply to any system in which information is stored, inherited with
%   variation, and determines the differential survival of the carrier."
%   (Adami, 2006)
...
% Models & simulations
% - "range of variation available for selection in conventional models and
%   simulations is defined at the outset, and it is impossible for any novel
%   type to arise" (Yedid, 2001)
% - "Used in this way, the system can be viewed as a halfway house between
%   conventional algebraic theory, which generates an- alytical predictions at
%   the expense of making restrictive as- sumptions, and populations of
%   microbes, where the details of evolutionary mechanics are often
%   inaccessible." (Yedid, 2001)
% - "It is difficult to see, however, that con- ventional theory is capable,
%   even in principle, of dealing with evolutionary novelty. Self-replicating
%   programs, on the other hand, provide open systems in which the emer- gence
%   and fate of new modes of genome organization can be studied." (Yedid, 2001)
...
% - Computational simulations of evolution can be considered as instances of
%   evolution (Pennock 2007)
